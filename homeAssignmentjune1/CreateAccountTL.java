...
String acc="Abishektestleafjune1";
...
//Storing the account name value in text 1
String text1 = driver.findElement(By.className("tabletext")).getText();
System.out.println(text1);
//Verifying whether created account value is valid from acc
if(text1.contains(acc))
{
